...
public class Project implements Serializable{
	...
	private String overhaulContent;		//大修改造内容
	private Double completedFinalPrice;	//竣工决算价
	private Date inputOperationDate;	//投入运行日期
	...
	@Column(name="OVERHAUL_CONTENT",nullable=true,length=2000)
	...
	@Column(name="COMPLETED_FINAL_PRICE",nullable=true)
	public Double getCompletedFinalPrice() {
		return completedFinalPrice;
	}

	public void setCompletedFinalPrice(Double completedFinalPrice) {
		this.completedFinalPrice = completedFinalPrice;
	}
	...
	@Column(name = "SHORT_NAME", nullable = true, length = 400)
	...
	@Column(name = "INPUT_OPERATION_DATE")
	public Date getInputOperationDate() {
		return inputOperationDate;
	}

	public void setInputOperationDate(Date inputOperationDate) {
		this.inputOperationDate = inputOperationDate;
	}

	@Column(name = "LINE_CODE_ID", nullable = true, length = 40)

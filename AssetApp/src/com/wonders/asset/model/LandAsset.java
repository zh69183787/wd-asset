...
/**
 * TLandasset entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_LANDASSET")
public class LandAsset implements java.io.Serializable {
	...
	private String undergroundRequisitionArea;
	private Integer no;
	...
	@Column(name = "UNDERGROUND_REQUISITION_AREA", length = 100)
	public String getUndergroundRequisitionArea() {
		return undergroundRequisitionArea;
	}

	public void setUndergroundRequisitionArea(String undergroundRequisitionArea) {
		this.undergroundRequisitionArea = undergroundRequisitionArea;
	}
	...
	/** full constructor */
	public LandAsset(String inclandRequisitionArea, Double landTotalFee,
                     ...
                     String buildArea, Double landTotalArea, String landRequisitionArea,
                     String updater, Date updateTime, String creator, String publish,
                     String id,String lineCodeId) {
	...
	public String getLandassetId() {
		return this.landassetId;
	}

	public void setLandassetId(String landassetId) {

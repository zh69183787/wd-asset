...
@Entity
@Table(name = "T_HOUSE_ASSET_TMP")
public class HouseAssetDto implements java.io.Serializable {
	...
	/** full constructor */
	public HouseAssetDto(String contractNo, String cardId, String project,
	...
	@XmlElement(name = "transDepLeader")
	...
	@XmlElement(name = "takeOverLeader")
	...
	@Transient
    @XmlElementWrapper(name = "AreaInfoList")
    @XmlElements({
            @XmlElement(name="AreaInfo", type = AreaInfoDto.class)
    })
	public List<AreaInfoDto> getAreaInfoList() {
		return areaInfoList;
	}

	public void setAreaInfoList(List<AreaInfoDto> areaInfoList) {
